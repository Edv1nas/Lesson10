...
def num_addition(number1:int, number2:int) -> int:
    return number1 + number2

def num_subtracion(number1:int, number2:int) -> int:
    return number1 - number2

def num_division(number1:int, number2:int) -> int:
    return number1 / number2

def num_multiplication(number1:int, number2:int) -> int:
    return number1 * number2
...
print(number1, "/", number2, "=", round(num_division(number1, number2,),2))
